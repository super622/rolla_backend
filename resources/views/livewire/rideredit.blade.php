        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Rider Edit</li>
                </ol>
            </nav>
            <h2 class="h4">Rider Detail</h2>
        </div>
    </div>
    
    <form wire:submit.prevent="updateRider">
        <div class = "row">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                                @if(gettype($photo) == 'string')
                                    <img src="{{ asset('storage/' . $photo) }}" class="rounded avatar-xl" alt="Driver Photo">
                                @else
                ...
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input wire:model.lazy="first_name" class="form-control" id="first_name" type="text" placeholder="Enter your first_name" value="{{ $first_name }}">
                            @error('first_name') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="last_name">Last Name</label>
                            <input wire:model.lazy="last_name" class="form-control" id="last_name" type="text" placeholder="Enter your last_name" value="{{ $last_name }}">
