        ...
        <table class="table table-flush" id="datatable">
            ...
            <tbody>
                @foreach($requests as $item)
                    @php
                        $start_location = strlen($item->start_location) > 30 ? substr($item->start_location, 0, 30) . "..." : $item->start_location;
                        $end_location = strlen($item->end_location) > 30 ? substr($item->end_location, 0, 30) . "..." : $item->end_location;
                    @endphp
                    <tr>
                        ...
                        <td>
                            <div class="d-flex aligh-items-center">
                                <a href="/order/{{ $item->id }}" class="me-md-1">
