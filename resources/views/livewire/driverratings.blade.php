<div>
    <title>Driver Rating Management</title>
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Driver Rating List</li>
                </ol>
            </nav>
            <h2 class="h4">Driver Rating List</h2>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex aligh-items-center">
                                <a href="/driverratings/{{ $item->id }}" class="me-md-1">
...
<script>
    ...
    function remove_ratings(id) {
        swalWithBootstrapButtons.fire({
            title: 'Do you want to delete all reviews for this driver?',
