    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="/notifications">Notification List</a></li>
                <li class="breadcrumb-item active" aria-current="page">Notification Details</li>
            </ol>
        </nav>
        <h2 class="h4">Notification Detial</h2>
    </div>
...
<div>
    <div class="row">
        ...
        <div class="col-12 col-xl-12">
            <div class="card shadow border-0 p-0 mt-sm-md">
                <div class="card-body">
                    <h4>This is a notification title</h4>
                    <div>
                        <p>
