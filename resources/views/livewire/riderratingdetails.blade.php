<div>
    <title>Rider Rating Details</title>
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="/riderratings">Rider Rating List</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Rider Rating Details</li>
                </ol>
            </nav>
            <h2 class="h4">Rider Rating Detail</h2>
        </div>
